...
<body>
    ...
    <center><div>
     ...
     <form action="Conexion/EliminarArea.php" method="post">
  <div id="msform">
    <ul id="progressbar">
    </ul>
    <fieldset>
      ...
      <h2 class="fs-title" style="margin-top: 27px;    font-size: 20px;">Eliminar Colaborador</h2>
                     <center><label style="color:black">Seleccionar Area</label></center> 
                                    <select name="area" onchange="buscar_ajax(this.value);" required>            
        ...
        <br>
        <br>
                 <input type="submit" class="next action-button" value="Eliminar" />
    </fieldset>
  </div>
</form>
