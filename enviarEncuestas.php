        ...
        <ul id="progressbar">
            ...
            <fieldset>
                ...
                <span style="color:black;"><font size = "3">Seleccionar colaborador</font></span><br>
                 ...
                 <center><input  id="asignar" name="asignar" type="submit" name="next" class="next action-button" value="Ver" /></center>
...
$(document).ready(function() {
    $('#asignar').on('click', function(e) {
       ...
       // alert("valores form:  "+dataString);
        var url = "Conexion/consultaEvaluadores.php";
        $.ajax({
